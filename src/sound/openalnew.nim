...
proc alIsEnabled*(capability: ALenum): ALboolean
##
##  State retrieval
##

proc alGetString*(param: ALenum): ptr ALchar
proc alGetBooleanv*(param: ALenum; data: ptr ALboolean)
...
proc alGetBoolean*(param: ALenum): ALboolean
...
proc alIsExtensionPresent*(extname: ptr ALchar): ALboolean
proc alGetProcAddress*(fname: ptr ALchar): pointer
proc alGetEnumValue*(ename: ptr ALchar): ALenum
##
##  LISTENER
...
proc alIsSource*(sid: ALuint): ALboolean
##
...
proc alIsBuffer*(bid: ALuint): ALboolean
##  Specify the data to be copied into a buffer

proc alBufferData*(bid: ALuint; format: ALenum; data: ptr ALvoid; size: ALsizei;
                  freq: ALsizei)
##
